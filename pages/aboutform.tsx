...
import styles from '../styles/aboutf.module.css'
...
{dis()}
   ...
   // let ph=((document.getElementById("Img") as HTMLInputElement).value)
    const formData1 = new FormData(event.target);
    formData1.set("Function", "Update");
      fetch('http://localhost:3000/api/about/aboutpost',
       {
         method: 'POST',
         body: formData1,
        })
              ...
              <div className=" ms-4 me-4 mt-5">
                <div className={`${styles.homenav} mt-3 p-4`}>
                  <form id="homeData" onSubmit={handleSubmit} >
                    ...
                    {image.preview ? (
                      <>
                        <img src={image.preview}  alt="dummy" id ="pic"  width="300" height="200" />
                      ...
                      <>           
                       <div className={`${styles.box1}   bg-white m-0 mt-4 p-0 position-relative`} >
                        <div className={`${styles.box2} m-4 `}>
                          ...
                          <button className={`${styles.btncolor} border-0 text-white p-1 px-4   `}   onClick={upFile}  >Search</button>
